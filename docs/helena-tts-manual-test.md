# Teste manual: saída de voz da Helena

## Escopo

Validar Text-to-Speech no chat principal da Helena sem alterar o fluxo de chat, contexto, tool calling, MCP ou AI Router.
...
10. Testar em navegador sem suporte ou com speech desabilitado e confirmar que a UI mostra indisponibilidade sem quebrar o chat.
