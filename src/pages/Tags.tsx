...
import { Tag, FileText, Search, Quote, Trash2 } from "lucide-react";
        ...
        {selectedTag ? (
                  ...
                  <div className="p-4 space-y-2">
                    {selectedSnippets.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-xs text-muted-foreground">Nenhum trecho tageado. Selecione texto numa nota e use "Tagear trecho".</p>
                      </div>
                    ) : selectedSnippets.map(s => (
                      <div key={s.id} className="p-4 rounded-xl border border-border bg-card hover:shadow-elevated transition-all">
                        <div className="flex items-start justify-between gap-2">
                          <blockquote className="border-l-2 border-primary pl-3 text-sm italic text-foreground flex-1">
                            "{s.snippet_text}"
                          </blockquote>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Selecione uma tag para ver notas e trechos associados</p>
            </div>
          </div>
        )}
      </div>
