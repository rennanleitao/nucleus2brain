    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-6 animate-fade-in">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-card border border-border rounded-lg py-2.5 text-sm font-medium hover:bg-accent transition-colors disabled:opacity-50"
        >
