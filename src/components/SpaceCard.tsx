  ...
  if (variant === "list") {
    return (
      <button
        ref={ref}
        onClick={handleClick}
        className="flex items-center gap-3 w-full px-4 py-3 bg-background border border-border rounded-xl hover:border-foreground/20 hover:shadow-sm transition-all text-left animate-fade-in touch-manipulation active:scale-[0.99] group"
      >
